...
/**
 * Timetable List functionality Controller which can Performs operation for
 * list, search and delete operations of Timetable
 *
 * @author Sagar Hans
 */
...
public class TimeTableListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println(request.getParameter("exam") + "fffffffff");
//		bean.setId(DataUtility.getLong(request.getParameter("id")));
		...
		tb.setExam_Date(DataUtility.getDate(request.getParameter("exam")));
