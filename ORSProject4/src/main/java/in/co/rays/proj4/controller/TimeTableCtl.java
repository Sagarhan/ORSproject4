...
/**
 * TimeTable functionality Controller which can Performs operation for add,
 * update, delete and get TimeTable
 *
 * @author Sagar Hans
 */
...
public class TimeTableCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("ExDate"))) {
			 ...
			 * request.setAttribute("ExDate", PropertyReader.getValue("error.date",
