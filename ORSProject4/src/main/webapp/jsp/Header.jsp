...
<%@page import="com.sun.mail.util.LogOutputStream"%>
<%-- <%@page import="in.co.rays.proj4.controller.Logoutctl"%> --%>
...
<table width="100%" border="0">
 ...
 %></td>
		<td rowspan="2">
			<h1 align="right">
				<img src="<%=ORSView.APP_CONTEXT%>/img/rays.png" width="300"
					height="100">
			</h1>
		</td>
	</tr>
	...
	<tr>
		<td colspan="2"><a href="<%=ORSView.MY_PROFILE_CTL%>">My
				...
				Password</a>| <a href="<%=ORSView.GET_MARKSHEET_CTL%>">Get Marksheet</a>|
